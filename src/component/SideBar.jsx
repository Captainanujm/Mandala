  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {/* Navigation */}
        <nav className="flex flex-col items-end px-6 space-y-6 font-['Playfair_Display'] font-bold text-[42px] leading-[54px] tracking-[-0.02em] text-right">
        <a
  href="#"
  className="relative inline-block font-['Playfair_Display'] font-bold text-[42px] leading-[54px] tracking-[-0.02em] text-[#CC7A00]"
>
  {/* Decorative strokes (above-left of text) */}
                <svg
                  width="47"
                  height="60"
                  viewBox="0 0 47 60"
                  className="absolute -top-6 -left-8" // yahan shift control hoga
                  fill="none"
  ...
  <span className="border-b-[5px] border-dotted border-[#CC7A00] pb-1 m-2">
    Home
      ...
      <div className="pt-4 flex flex-col items-center justify-center mt-10">
        <div className="flex items-center justify-center space-x-2 text-[#664000]">
         <svg
  xmlns="http://www.w3.org/2000/svg"
  className="h-6 w-6"
  viewBox="0 0 24 24"
...
>
  ...
  />
          ...
          <p className="font-[Lato]  text-[19px] leading-[100%] tracking-[0] text-right text-[#664000]">
                clayboykin@gmail.com
                     </p>
        </div>
        <div className="flex items-center justify-end space-x-2 mt-2 text-[#664000]">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  <path strokeLinecap="round" strokeLinejoin="round" d="M2 5.5C2 4.67 2.67 4 3.5 4h3a1 1 0 01.93.63l1.26 3.02a1 1 0 01-.27 1.11l-1.7 1.7a15.05 15.05 0 006.36 6.36l1.7-1.7a1 1 0 011.11-.27l3.02 1.26a1 1 0 01.63.93v3c0 .83-.67 1.5-1.5 1.5h-1C9.27 21 3 14.73 3 7V5.5z" />
</svg>

          <span className="font-[Lato]  text-[19px] leading-[100%] tracking-[0] text-right text-[#664000] ">512.971.2895</span>
        </div>
      </div>
  ...
  >
    ...
    >
      <path d="M23.498 6.186a2.974 2.974 0 0 0-2.094-2.103C19.233 3.5 
        ...
        {/* Footer */}
       <p className="font-[Lato] font-semibold text-[19px]  mb-6 leading-[100%] tracking-[0] text-center text-[#664000]">
