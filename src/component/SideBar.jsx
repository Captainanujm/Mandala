...
const RightSidebar = ({ isOpen, onClose }) => {
  return (
   <div
  className={`fixed top-0 right-1 min-h-screen sm:min-w-screen bg-[#FFF6E9] shadow-lg transform transition-transform duration-300 z-50 flex flex-col justify-between
