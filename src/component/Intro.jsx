            ...
            <div className="max-w-6xl sm:mx-auto mx-0">
                ...
                <div className="text-center ">
                    <div className="flex items-center justify-center gap-2 mb-4">
                        <h1 className="sm:text-[52px] text-[40px] leading-[64px] font-bold italic tracking-[-0.03em] font-playfair text-center">
                        ...
                        <svg
                            ...
                            className="relative sm:-top-8 -top-14 shrink-0"
                        >
                            <path
                    ...
                    <p className="mx-2 text-center sm:text-[22px] text-[19px] leading-[100%] font-semibold text-[#66400080] max-w-4xl sm:mx-auto font-lato">
                        ...
                        <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <path d="M24.7477 8.89824C24.8585 7.94743 22.6689 7.75375 15.4194 8.04339C7.7456 8.35497 6.06415 8.70296 6.32812 9.82075C6.71005 11.3535 24.5288 10.4313 24.7477 8.89824Z" fill="#CC7A00" />
                            <path d="M28.197 33.7452C31.0585 33.8734 31.4485 33.3994 33.5967 27.2011C35.8222 20.8015 36.0009 19.5533 34.8362 19.0369C32.7204 18.1092 31.5879 19.615 28.4405 27.3934C26.1216 33.1334 26.0848 33.6506 28.197 33.7452Z" fill="#CC7A00" />
                            <path d="M9.81448 30.5135C11.8709 30.6329 12.6386 30.2576 15.1735 27.9271C22.6664 20.9853 28.5692 16.621 24.5618 16.4688C22.9266 16.3956 21.4006 17.5424 12.366 25.371C7.39223 29.7222 7.06436 30.3356 9.81448 30.5135Z" fill="#CC7A00" />
                        </svg>
                    </div>
                ...
                <div className="text-center my-16 lg:my-24 mr-2">
                    <div className="flex flex-col items-center text-center max-w-3xl mx-auto relative px-8 sm:px-0">
                        ...
                        <p className="font-lato italic text-xl sm:text-2xl lg:text-3xl leading-snug lg:leading-normal text-[#664000]">
                            To guide individuals—<span className="text-[#CC7A00]">for men & women</span>—toward rediscovering their <span className="text-[#CC7A00]">inner compass</span>, and to <span className="text-[#CC7A00]">create safe spaces</span> for open-hearted dialogue.
                        </p>
                    </div>
                </div>
